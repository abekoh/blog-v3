...
- データベース
  - RDBはPostgreSQL, Oracle Databaseの経験が長い
  - ORMを使わずSQLやそれに近いものを書くスタイルが好き。Goだと[sqlc](https://sqlc.dev/)、Javaだと[MyBatis](https://mybatis.org/mybatis-3/)をよく使う
...
- 特に好きな本、3冊あえて選ぶなら
  ...
  - [岩田さん](https://www.1101.com/books/iwatasan/free/?srsltid=AfmBOoobxrkfgO_sWg_dWLpKcZusOpXooNVc-I2IeKDcjcA-JE8v5oWf)
